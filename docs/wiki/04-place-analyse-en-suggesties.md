...
![Place-analyse in het feature editor-paneel](screenshots/04-place-analyse-overzicht.png)
...
![Voorbeeld van een foutmelding](screenshots/04-foutmelding.png)
...
![Voorbeeld van een waarschuwing](screenshots/04-waarschuwing.png)
...
![Voorbeeld van een informatiemelding](screenshots/04-informatiemelding.png)
...
![Huidige en voorgestelde waarde](screenshots/04-huidige-en-voorgestelde-waarde.png)
...
![Fix selecteren](screenshots/04-fix-selecteren.png)

![Geselecteerde fixes toepassen](screenshots/04-geselecteerde-fixes-toepassen.png)
...
![Handmatige actie vereist](screenshots/04-handmatige-actie.png)
...
![Externe provider keuze](screenshots/04-externe-provider-keuze.png)
...
![Ketenherkenning in analysepaneel](screenshots/04-ketenherkenning.png)
...
![Geen bevindingen](screenshots/04-geen-bevindingen.png)
